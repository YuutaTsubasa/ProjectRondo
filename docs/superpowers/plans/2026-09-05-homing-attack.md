...
- **`src/domain/` stays pure** — no babylon, Svelte, DOM or IO imports, ever. Vitest-covered, TDD red-then-green. Presentation is verified in-browser, never unit-tested.
