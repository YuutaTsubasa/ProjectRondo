...
| `ambience/wind_field.ogg` | `Open_grassland_wind__#2-1788553077631.wav` | *(to fill in)* | *(to fill in)* |
| `ambience/water_pond.ogg` | `Natural_stream_water_#3-1788553102614.wav` | *(to fill in)* | *(to fill in)* |
